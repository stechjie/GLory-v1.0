...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/dark_queen_animated/dark_queen_idle_smooth.fbx",
	"attack": "res://assets/models/units/dark_queen_animated/dark_queen_attack_smooth.fbx",
	"run": "res://assets/models/units/dark_queen_animated/dark_queen_run_smooth.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/dark_queen_animated/dark_queen_body_material.tres"
