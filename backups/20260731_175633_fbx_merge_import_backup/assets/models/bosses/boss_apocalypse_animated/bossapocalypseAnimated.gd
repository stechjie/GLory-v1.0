...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_apocalypse_animated/boss_apocalypse_idle.fbx",
	"attack": "res://assets/models/bosses/boss_apocalypse_animated/boss_apocalypse_attack.fbx",
	"run": "res://assets/models/bosses/boss_apocalypse_animated/boss_apocalypse_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_apocalypse_animated/boss_apocalypse_body_material.tres"
