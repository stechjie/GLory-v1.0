...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_soul_devourer_animated/boss_soul_devourer_idle.fbx",
	"attack": "res://assets/models/bosses/boss_soul_devourer_animated/boss_soul_devourer_attack.fbx",
	"run": "res://assets/models/bosses/boss_soul_devourer_animated/boss_soul_devourer_run.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_soul_devourer_animated/boss_soul_devourer_body_material.tres"
