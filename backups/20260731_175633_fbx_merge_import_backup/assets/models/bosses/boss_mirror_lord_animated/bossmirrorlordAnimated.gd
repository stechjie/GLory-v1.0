...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_mirror_lord_animated/boss_mirror_lord_idle.fbx",
	"attack": "res://assets/models/bosses/boss_mirror_lord_animated/boss_mirror_lord_attack.fbx",
	"run": "res://assets/models/bosses/boss_mirror_lord_animated/boss_mirror_lord_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_mirror_lord_animated/boss_mirror_lord_body_material.tres"
