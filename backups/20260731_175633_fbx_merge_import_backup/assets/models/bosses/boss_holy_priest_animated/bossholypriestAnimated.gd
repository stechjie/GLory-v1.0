...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_holy_priest_animated/boss_holy_priest_idle.fbx",
	"attack": "res://assets/models/bosses/boss_holy_priest_animated/boss_holy_priest_attack.fbx",
	"run": "res://assets/models/bosses/boss_holy_priest_animated/boss_holy_priest_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_holy_priest_animated/boss_holy_priest_body_material.tres"
