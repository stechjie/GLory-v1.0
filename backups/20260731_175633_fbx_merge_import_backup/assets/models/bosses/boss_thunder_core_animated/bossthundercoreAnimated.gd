...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_thunder_core_animated/boss_thunder_core_idle.fbx",
	"attack": "res://assets/models/bosses/boss_thunder_core_animated/boss_thunder_core_attack.fbx",
	"run": "res://assets/models/bosses/boss_thunder_core_animated/boss_thunder_core_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_thunder_core_animated/boss_thunder_core_body_material.tres"
