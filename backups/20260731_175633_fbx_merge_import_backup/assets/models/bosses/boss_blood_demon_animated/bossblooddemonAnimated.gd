...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_blood_demon_animated/boss_blood_demon_idle.fbx",
	"attack": "res://assets/models/bosses/boss_blood_demon_animated/boss_blood_demon_attack.fbx",
	"run": "res://assets/models/bosses/boss_blood_demon_animated/boss_blood_demon_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_blood_demon_animated/boss_blood_demon_body_material.tres"
