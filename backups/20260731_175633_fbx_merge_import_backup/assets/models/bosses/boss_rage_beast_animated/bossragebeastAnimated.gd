...
const ACTION_SCENES := {
	"idle": "res://assets/models/bosses/boss_rage_beast_animated/boss_rage_beast_idle.fbx",
	"attack": "res://assets/models/bosses/boss_rage_beast_animated/boss_rage_beast_attack.fbx",
	"run": "res://assets/models/bosses/boss_rage_beast_animated/boss_rage_beast_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/bosses/boss_rage_beast_animated/boss_rage_beast_body_material.tres"
