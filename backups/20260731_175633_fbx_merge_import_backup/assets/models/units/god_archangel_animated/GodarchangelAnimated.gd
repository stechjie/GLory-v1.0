...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/god_archangel_animated/god_archangel_idle.fbx",
	"attack": "res://assets/models/units/god_archangel_animated/god_archangel_attack.fbx",
	"run": "res://assets/models/units/god_archangel_animated/god_archangel_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/god_archangel_animated/god_archangel_body_material.tres"
