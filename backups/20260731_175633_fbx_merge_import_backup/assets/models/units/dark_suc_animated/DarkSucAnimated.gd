...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/dark_suc_animated/dark_suc_idle.fbx",
	"attack": "res://assets/models/units/dark_suc_animated/dark_suc_attack.fbx",
	"run": "res://assets/models/units/dark_suc_animated/dark_suc_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/dark_suc_animated/dark_suc_body_material.tres"
