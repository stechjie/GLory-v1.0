...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/dark_scythe_animated/dark_scythe_idle.fbx",
	"attack": "res://assets/models/units/dark_scythe_animated/dark_scythe_attack.fbx",
	"run": "res://assets/models/units/dark_scythe_animated/dark_scythe_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/dark_scythe_animated/dark_scythe_body_material.tres"
