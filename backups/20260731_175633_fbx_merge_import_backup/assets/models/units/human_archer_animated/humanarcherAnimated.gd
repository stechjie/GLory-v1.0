...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/human_archer_animated/human_archer_idle.fbx",
	"attack": "res://assets/models/units/human_archer_animated/human_archer_attack.fbx",
	"run": "res://assets/models/units/human_archer_animated/human_archer_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/human_archer_animated/human_archer_body_material.tres"
