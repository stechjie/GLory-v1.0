...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/dark_queen_animated/dark_queen_idle.fbx",
	"attack": "res://assets/models/units/dark_queen_animated/dark_queen_attack.fbx",
	"run": "res://assets/models/units/dark_queen_animated/dark_queen_run.fbx"
}
