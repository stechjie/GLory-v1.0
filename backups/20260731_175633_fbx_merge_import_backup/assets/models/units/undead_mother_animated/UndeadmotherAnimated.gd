...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_mother_animated/undead_mother_idle.fbx",
	"attack": "res://assets/models/units/undead_mother_animated/undead_mother_attack.fbx",
	"run": "res://assets/models/units/undead_mother_animated/undead_mother_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_mother_animated/undead_mother_body_material.tres"
