...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_spike_animated/undead_spike_idle.fbx",
	"attack": "res://assets/models/units/undead_spike_animated/undead_spike_attack.fbx",
	"run": "res://assets/models/units/undead_spike_animated/undead_spike_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_spike_animated/undead_spike_body_material.tres"
