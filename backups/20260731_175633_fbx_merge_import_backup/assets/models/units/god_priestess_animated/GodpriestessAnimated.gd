...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/god_priestess_animated/god_priestess_idle.fbx",
	"attack": "res://assets/models/units/god_priestess_animated/god_priestess_attack.fbx",
	"run": "res://assets/models/units/god_priestess_animated/god_priestess_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/god_priestess_animated/god_priestess_body_material.tres"
