...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/human_merchant_green_cloak/human_merchant_idle.fbx",
	"attack": "res://assets/models/units/human_merchant_green_cloak/human_merchant_attack.fbx",
	"run": "res://assets/models/units/human_merchant_green_cloak/human_merchant_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/human_merchant_green_cloak/human_merchant_body_material.tres"
