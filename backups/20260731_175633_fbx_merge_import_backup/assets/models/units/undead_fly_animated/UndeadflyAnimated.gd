...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_fly_animated/undead_fly_idle.fbx",
	"attack": "res://assets/models/units/undead_fly_animated/undead_fly_attack.fbx",
	"run": "res://assets/models/units/undead_fly_animated/undead_fly_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_fly_animated/undead_fly_body_material.tres"
