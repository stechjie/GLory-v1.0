...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_small_animated/undead_small_idle.fbx",
	"attack": "res://assets/models/units/undead_small_animated/undead_small_attack.fbx",
	"run": "res://assets/models/units/undead_small_animated/undead_small_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_small_animated/undead_small_body_material.tres"
