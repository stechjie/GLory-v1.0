...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_titan_animated/undead_titan_idle.fbx",
	"attack": "res://assets/models/units/undead_titan_animated/undead_titan_attack.fbx",
	"run": "res://assets/models/units/undead_titan_animated/undead_titan_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_titan_animated/undead_titan_body_material.tres"
