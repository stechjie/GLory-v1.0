...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_poison_animated/undead_poison_idle.fbx",
	"attack": "res://assets/models/units/undead_poison_animated/undead_poison_attack.fbx",
	"run": "res://assets/models/units/undead_poison_animated/undead_poison_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_poison_animated/undead_poison_body_material.tres"
