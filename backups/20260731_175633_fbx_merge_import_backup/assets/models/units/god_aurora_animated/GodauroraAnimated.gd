...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/god_aurora_animated/god_aurora_idle.fbx",
	"attack": "res://assets/models/units/god_aurora_animated/god_aurora_attack.fbx",
	"run": "res://assets/models/units/god_aurora_animated/god_aurora_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/god_aurora_animated/god_aurora_body_material.tres"
