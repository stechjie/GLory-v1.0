...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_parasite_animated/undead_parasite_idle.fbx",
	"attack": "res://assets/models/units/undead_parasite_animated/undead_parasite_attack.fbx",
	"run": "res://assets/models/units/undead_parasite_animated/undead_parasite_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_parasite_animated/undead_parasite_body_material.tres"
