...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/god_king_animated/god_king_idle.fbx",
	"attack": "res://assets/models/units/god_king_animated/god_king_attack.fbx",
	"run": "res://assets/models/units/god_king_animated/god_king_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/god_king_animated/god_king_body_material.tres"
