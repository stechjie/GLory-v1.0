...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/god_angel_animated/god_angel_idle.fbx",
	"attack": "res://assets/models/units/god_angel_animated/god_angel_attack.fbx",
	"run": "res://assets/models/units/god_angel_animated/god_angel_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/god_angel_animated/god_angel_body_material.tres"
