...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/human_mage_animated/human_mage_idle.fbx",
	"attack": "res://assets/models/units/human_mage_animated/human_mage_attack.fbx",
	"run": "res://assets/models/units/human_mage_animated/human_mage_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/human_mage_animated/human_mage_body_material.tres"
