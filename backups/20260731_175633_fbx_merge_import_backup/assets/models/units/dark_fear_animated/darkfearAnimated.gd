...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/dark_fear_animated/dark_fear_idle.fbx",
	"attack": "res://assets/models/units/dark_fear_animated/dark_fear_attack.fbx",
	"run": "res://assets/models/units/dark_fear_animated/dark_fear_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/dark_fear_animated/dark_fear_body_material.tres"
