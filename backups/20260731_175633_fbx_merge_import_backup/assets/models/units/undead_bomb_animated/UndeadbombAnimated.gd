...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/undead_bomb_animated/undead_bomb_idle.fbx",
	"attack": "res://assets/models/units/undead_bomb_animated/undead_bomb_attack.fbx",
	"run": "res://assets/models/units/undead_bomb_animated/undead_bomb_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/undead_bomb_animated/undead_bomb_body_material.tres"
