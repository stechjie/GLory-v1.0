...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/human_cleric_animated/human_cleric_idle.fbx",
	"attack": "res://assets/models/units/human_cleric_animated/human_cleric_attack.fbx",
	"run": "res://assets/models/units/human_cleric_animated/human_cleric_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/human_cleric_animated/human_cleric_body_material.tres"
