...
const ACTION_SCENES := {
	"idle": "res://assets/models/units/human_death_servant_animated/human_death_servant_idle.fbx",
	"attack": "res://assets/models/units/human_death_servant_animated/human_death_servant_attack.fbx",
	"run": "res://assets/models/units/human_death_servant_animated/human_death_servant_run.fbx"
}
const BODY_MATERIAL_PATH := "res://assets/models/units/human_death_servant_animated/human_death_servant_body_material.tres"
