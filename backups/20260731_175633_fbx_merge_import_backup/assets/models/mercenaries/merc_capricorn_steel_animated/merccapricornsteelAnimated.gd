...
const ACTION_SCENES := {
	"idle": "res://assets/models/mercenaries/merc_capricorn_steel_animated/merc_capricorn_steel_idle.fbx",
	"attack": "res://assets/models/mercenaries/merc_capricorn_steel_animated/merc_capricorn_steel_attack.fbx",
	"run": "res://assets/models/mercenaries/merc_capricorn_steel_animated/merc_capricorn_steel_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/mercenaries/merc_capricorn_steel_animated/merc_capricorn_steel_body_material.tres"
