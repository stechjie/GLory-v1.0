...
const ACTION_SCENES := {
	"idle": "res://assets/models/mercenaries/merc_aquarius_time_animated/merc_aquarius_time_Idle.fbx",
	"attack": "res://assets/models/mercenaries/merc_aquarius_time_animated/merc_aquarius_time_attack.fbx",
	"run": "res://assets/models/mercenaries/merc_aquarius_time_animated/merc_aquarius_time_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/mercenaries/merc_aquarius_time_animated/merc_aquarius_time_body_material.tres"
