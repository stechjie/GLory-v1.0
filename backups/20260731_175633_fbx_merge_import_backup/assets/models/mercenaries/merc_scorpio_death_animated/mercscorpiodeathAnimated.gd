...
const ACTION_SCENES := {
	"idle": "res://assets/models/mercenaries/merc_scorpio_death_animated/merc_scorpio_death_Idle.fbx",
	"attack": "res://assets/models/mercenaries/merc_scorpio_death_animated/merc_scorpio_death_attack.fbx",
	"run": "res://assets/models/mercenaries/merc_scorpio_death_animated/merc_scorpio_death_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/mercenaries/merc_scorpio_death_animated/merc_scorpio_death_body_material.tres"
