...
const ACTION_SCENES := {
	"idle": "res://assets/models/mercenaries/merc_cancer_shell_animated/merc_cancer_shell_idle.fbx",
	"attack": "res://assets/models/mercenaries/merc_cancer_shell_animated/merc_cancer_shell_attack.fbx",
	"run": "res://assets/models/mercenaries/merc_cancer_shell_animated/merc_cancer_shell_run.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/mercenaries/merc_cancer_shell_animated/merc_cancer_shell_body_material.tres"
