...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/sky/pve_sky_wind_falcon_animated/pve_sky_wind_falcon_idle.fbx",
	"attack": "res://assets/models/monsters/sky/pve_sky_wind_falcon_animated/pve_sky_wind_falcon_attack.fbx",
	"run": "res://assets/models/monsters/sky/pve_sky_wind_falcon_animated/pve_sky_wind_falcon_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/sky/pve_sky_wind_falcon_animated/pve_sky_wind_falcon_body_material.tres"
