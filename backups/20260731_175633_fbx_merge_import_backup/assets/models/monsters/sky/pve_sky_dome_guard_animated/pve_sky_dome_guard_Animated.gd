...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/sky/pve_sky_dome_guard_animated/pve_sky_dome_guard_idle.fbx",
	"attack": "res://assets/models/monsters/sky/pve_sky_dome_guard_animated/pve_sky_dome_guard_attack.fbx",
	"run": "res://assets/models/monsters/sky/pve_sky_dome_guard_animated/pve_sky_dome_guard_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/sky/pve_sky_dome_guard_animated/pve_sky_dome_guard_body_material.tres"
