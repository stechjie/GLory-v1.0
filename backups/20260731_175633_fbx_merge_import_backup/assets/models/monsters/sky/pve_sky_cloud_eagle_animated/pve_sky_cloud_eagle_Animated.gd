...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/sky/pve_sky_cloud_eagle_animated/pve_sky_cloud_eagle_idle.fbx",
	"attack": "res://assets/models/monsters/sky/pve_sky_cloud_eagle_animated/pve_sky_cloud_eagle_attack.fbx",
	"run": "res://assets/models/monsters/sky/pve_sky_cloud_eagle_animated/pve_sky_cloud_eagle_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/sky/pve_sky_cloud_eagle_animated/pve_sky_cloud_eagle_body_material.tres"
