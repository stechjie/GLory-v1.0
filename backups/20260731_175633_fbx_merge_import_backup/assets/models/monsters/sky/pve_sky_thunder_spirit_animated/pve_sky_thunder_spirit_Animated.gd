...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/sky/pve_sky_thunder_spirit_animated/pve_sky_thunder_spirit_idle.fbx",
	"attack": "res://assets/models/monsters/sky/pve_sky_thunder_spirit_animated/pve_sky_thunder_spirit_attack.fbx",
	"run": "res://assets/models/monsters/sky/pve_sky_thunder_spirit_animated/pve_sky_thunder_spirit_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/sky/pve_sky_thunder_spirit_animated/pve_sky_thunder_spirit_body_material.tres"
