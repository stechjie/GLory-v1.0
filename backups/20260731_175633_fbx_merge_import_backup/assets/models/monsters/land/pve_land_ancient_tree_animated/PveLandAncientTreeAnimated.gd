...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/land/pve_land_ancient_tree_animated/pve_land_ancient_tree_idle.fbx",
	"attack": "res://assets/models/monsters/land/pve_land_ancient_tree_animated/pve_land_ancient_tree_attack.fbx",
	"run": "res://assets/models/monsters/land/pve_land_ancient_tree_animated/pve_land_ancient_tree_run.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/land/pve_land_ancient_tree_animated/pve_land_ancient_tree_body_material.tres"
