...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/land/pve_land_rock_beast_animated/pve_land_rock_beast_idle.fbx",
	"attack": "res://assets/models/monsters/land/pve_land_rock_beast_animated/pve_land_rock_beast_attack.fbx",
	"run": "res://assets/models/monsters/land/pve_land_rock_beast_animated/pve_land_rock_beast_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/land/pve_land_rock_beast_animated/pve_land_rock_beast_body_material.tres"
