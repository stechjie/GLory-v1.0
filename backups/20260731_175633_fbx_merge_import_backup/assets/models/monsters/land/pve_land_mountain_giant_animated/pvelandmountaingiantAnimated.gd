...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/land/pve_land_mountain_giant_animated/pve_land_mountain_giant_idle.fbx",
	"attack": "res://assets/models/monsters/land/pve_land_mountain_giant_animated/pve_land_mountain_giant_attack.fbx",
	"run": "res://assets/models/monsters/land/pve_land_mountain_giant_animated/pve_land_mountain_giant_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/land/pve_land_mountain_giant_animated/pve_land_mountain_giant_body_material.tres"
