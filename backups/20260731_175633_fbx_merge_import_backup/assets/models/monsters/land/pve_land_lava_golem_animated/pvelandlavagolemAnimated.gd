...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/land/pve_land_lava_golem_animated/pve_land_lava_golem_idle.fbx",
	"attack": "res://assets/models/monsters/land/pve_land_lava_golem_animated/pve_land_lava_golem_attack.fbx",
	"run": "res://assets/models/monsters/land/pve_land_lava_golem_animated/pve_land_lava_golem_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/land/pve_land_lava_golem_animated/pve_land_lava_golem_body_material.tres"
