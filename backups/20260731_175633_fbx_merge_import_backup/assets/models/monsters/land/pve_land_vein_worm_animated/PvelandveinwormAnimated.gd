...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/land/pve_land_vein_worm_animated/pve_land_vein_worm_idle.fbx",
	"attack": "res://assets/models/monsters/land/pve_land_vein_worm_animated/pve_land_vein_worm_attack.fbx",
	"run": "res://assets/models/monsters/land/pve_land_vein_worm_animated/pve_land_vein_worm_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/land/pve_land_vein_worm_animated/pve_land_vein_worm_body_material.tres"
