...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/ren/pve_ren_voodoo_witch_animated/pve_ren_voodoo_witch_idle.fbx",
	"attack": "res://assets/models/monsters/ren/pve_ren_voodoo_witch_animated/pve_ren_voodoo_witch_attack.fbx",
	"run": "res://assets/models/monsters/ren/pve_ren_voodoo_witch_animated/pve_ren_voodoo_witch_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/ren/pve_ren_voodoo_witch_animated/pve_ren_voodoo_witch_body_material.tres"
