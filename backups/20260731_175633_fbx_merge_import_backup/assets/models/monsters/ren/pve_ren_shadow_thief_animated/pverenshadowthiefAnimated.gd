...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/ren/pve_ren_shadow_thief_animated/pve_ren_shadow_thief_idle.fbx",
	"attack": "res://assets/models/monsters/ren/pve_ren_shadow_thief_animated/pve_ren_shadow_thief_attack.fbx",
	"run": "res://assets/models/monsters/ren/pve_ren_shadow_thief_animated/pve_ren_shadow_thief_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/ren/pve_ren_shadow_thief_animated/pve_ren_shadow_thief_body_material.tres"
