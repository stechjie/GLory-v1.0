...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/ren/pve_ren_poison_doctor_animated/pve_ren_poison_doctor_idle.fbx",
	"attack": "res://assets/models/monsters/ren/pve_ren_poison_doctor_animated/pve_ren_poison_doctor_attack.fbx",
	"run": "res://assets/models/monsters/ren/pve_ren_poison_doctor_animated/pve_ren_poison_doctor_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/ren/pve_ren_poison_doctor_animated/pve_ren_poison_doctor_body_material.tres"
