...
const ACTION_SCENES := {
	"idle": "res://assets/models/monsters/ren/pve_ren_puppet_master_animated/pve_ren_puppet_master_idle.fbx",
	"attack": "res://assets/models/monsters/ren/pve_ren_puppet_master_animated/pve_ren_puppet_master_attack.fbx",
	"run": "res://assets/models/monsters/ren/pve_ren_puppet_master_animated/pve_ren_puppet_master_walking.fbx",
}
const BODY_MATERIAL_PATH := "res://assets/models/monsters/ren/pve_ren_puppet_master_animated/pve_ren_puppet_master_body_material.tres"
