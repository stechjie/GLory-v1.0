...
### Current health (generated 2026-08-28T13:32:04Z)

| Item | Value |
| --- | --- |
| Commit | `d278b93` on `main` (12 dirty tracked, 4 untracked) |
| Asset inventory | `766575cb4b2a7019` / 2658 files |
| Gates | 46 known, 1 failing (1 from the run at 2026-08-28T13:22:41Z, rest from earlier runs) |
...
| Last device run | 2026-08-28T13:30:34Z on 25028RN03A (passed) |

Failing gates:

- `model_material_integrity` - nonzero_exit, 3 failures of 300 checked (observed 2026-08-28T12:32:16Z)
...
- **in_progress** (unassigned, V3 P0-01) - 启动阈值仍未打开：真机基线只有单次样本
...
- **not_started** (unassigned, 工具) - android_smoke.sh 会在没装上时打印 install ok
